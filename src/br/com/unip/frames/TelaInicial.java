...
public class TelaInicial extends JFrame {
	...
	public TelaInicial() {
		...
		sairButton.setBounds(331, 223, 89, 23);
		...
		btn_aluno.setBounds(152, 33, 89, 23);
		panel.add(btn_aluno);
		...
		btn_disc.setBounds(152, 126, 89, 23);
		panel.add(btn_disc);
		...
		btn_curso.setBounds(152, 171, 89, 23);
		panel.add(btn_curso);
		...
		btn_prof.setBounds(148, 76, 97, 23);
		panel.add(btn_prof);
